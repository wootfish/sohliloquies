...
[^4]: [Or, in Facebook's case, selling them to _just about anyone who bothers to put in a bid_](https://www.theguardian.com/technology/2018/dec/19/facebook-shared-user-data-private-messages-netflix-spotify-amazon-microsoft-sony).
...
If we want to get away from this set of issues, perhaps it makes sense to get away from centralization entirely. At the polar opposite from centralized systems are _distributed_ systems. These are peer-to-peer networks with protocols that provide a service through the power of mutual aid, a little bit like employee-run companies that anyone can join. When built well, these systems are surprisingly robust and can create reliable services that somehow exist _between_ the peers involved in maintaining them -- carving out what might reasonably be considered _public cyberspace_.
